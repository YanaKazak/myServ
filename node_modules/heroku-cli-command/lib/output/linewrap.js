...
var linewrap = module.exports = function (start, stop, params) {
  ...
  if ((typeof stop === 'undefined' ? 'undefined' : (0, _typeof3.default)(stop)) === 'object') {
    params = stop;
  ...
  if (preset) {
    ...
    for (i = 0; i < preset.length; i++) {
      ...
      if (item) {
        ...
        throw new TypeError('preset must be one of "' + (0, _keys2.default)(presetMap).join('", "') + '"');
      }
    }
  }
  ...
  if (params.mode) {
    if (modeMap[params.mode]) {
      ...
      throw new TypeError('mode must be one of "' + (0, _keys2.default)(modeMap).join('", "') + '"');
    }
  }
  ...
  if (params.whitespace) {
    if (wsMap[params.whitespace]) {
      ...
      throw new TypeError('whitespace must be one of "' + (0, _keys2.default)(wsMap).join('", "') + '"');
    }
  }
  ...
  if (params.respectLineBreaks) {
    if (rlbMap[params.respectLineBreaks] || rlbSMPat.test(params.respectLineBreaks)) {
      ...
      throw new TypeError('respectLineBreaks must be one of "' + (0, _keys2.default)(rlbMap).join('", "') + '", "m<num>", "s<num>"');
    }
  }
  ...
  if (params.skipScheme) {
    if (skipSchemeMap[params.skipScheme]) {
      ...
      throw new TypeError('skipScheme must be one of "' + (0, _keys2.default)(skipSchemeMap).join('", "') + '"');
    }
  }
  if (params.skip) {
    skip = params.skip;
  ...
  if (params.lineBreakScheme) {
    if (lineBreakSchemeMap[params.lineBreakScheme]) {
      ...
      throw new TypeError('lineBreakScheme must be one of "' + (0, _keys2.default)(lineBreakSchemeMap).join('", "') + '"');
    }
  }
  if (params.lineBreak) {
...
linewrap.hard = function () /*start, stop, params*/{
  ...
  if ((0, _typeof3.default)(args[last]) === 'object') {
    args[last].mode = 'hard';
  } else {
    args.push({ mode: 'hard' });
  }
